...
module.exports = (NODE) => {
    ...
    // On
    const onHH = STATION1.datetime.ll2.step2.onHH;
    const onHHTimer = STATION1.datetime.ll2.step2.onHHTimer;
    ...
    const onMM = STATION1.datetime.ll2.step2.onMM;
    const onMMTimer = STATION1.datetime.ll2.step2.onMMTimer;
    ...
    const onSS = STATION1.datetime.ll2.step2.onSS;
    const onSSTimer = STATION1.datetime.ll2.step2.onSSTimer;
    ...
    // Off
    const offHH = STATION1.datetime.ll2.step2.offHH;
    const offHHTimer = STATION1.datetime.ll2.step2.offHHTimer;
    ...
    const offMM = STATION1.datetime.ll2.step2.offMM;
    const offMMTimer = STATION1.datetime.ll2.step2.offMMTimer;
    ...
    const offSS = STATION1.datetime.ll2.step2.offSS;
    const offSSTimer = STATION1.datetime.ll2.step2.offSSTimer;
