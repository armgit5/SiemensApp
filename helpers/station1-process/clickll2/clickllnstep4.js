...
module.exports = (NODE) => {
    ...
    // On
    const onHH = STATION1.datetime.ll2.step4.onHH;
    const onHHTimer = STATION1.datetime.ll2.step4.onHHTimer;
    ...
    const onMM = STATION1.datetime.ll2.step4.onMM;
    const onMMTimer = STATION1.datetime.ll2.step4.onMMTimer;
    ...
    const onSS = STATION1.datetime.ll2.step4.onSS;
    const onSSTimer = STATION1.datetime.ll2.step4.onSSTimer;
    ...
    // Off
    const offHH = STATION1.datetime.ll2.step4.offHH;
    const offHHTimer = STATION1.datetime.ll2.step4.offHHTimer;
    ...
    const offMM = STATION1.datetime.ll2.step4.offMM;
    const offMMTimer = STATION1.datetime.ll2.step4.offMMTimer;
    ...
    const offSS = STATION1.datetime.ll2.step4.offSS;
    const offSSTimer = STATION1.datetime.ll2.step4.offSSTimer;
