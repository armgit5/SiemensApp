...
module.exports = (NODE) => {
    ...
    // On
    const onHH = STATION1.datetime.ll10.step3.onHH;
    const onHHTimer = STATION1.datetime.ll10.step3.onHHTimer;
    ...
    const onMM = STATION1.datetime.ll10.step3.onMM;
    const onMMTimer = STATION1.datetime.ll10.step3.onMMTimer;
    ...
    const onSS = STATION1.datetime.ll10.step3.onSS;
    const onSSTimer = STATION1.datetime.ll10.step3.onSSTimer;
    ...
    // Off
    const offHH = STATION1.datetime.ll10.step3.offHH;
    const offHHTimer = STATION1.datetime.ll10.step3.offHHTimer;
    ...
    const offMM = STATION1.datetime.ll10.step3.offMM;
    const offMMTimer = STATION1.datetime.ll10.step3.offMMTimer;
    ...
    const offSS = STATION1.datetime.ll10.step3.offSS;
    const offSSTimer = STATION1.datetime.ll10.step3.offSSTimer;
