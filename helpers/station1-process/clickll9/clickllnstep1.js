...
module.exports = (NODE) => {
    ...
    // On
    const onHH = STATION1.datetime.ll9.step1.onHH;
    const onHHTimer = STATION1.datetime.ll9.step1.onHHTimer;
    ...
    const onMM = STATION1.datetime.ll9.step1.onMM;
    const onMMTimer = STATION1.datetime.ll9.step1.onMMTimer;
    ...
    const onSS = STATION1.datetime.ll9.step1.onSS;
    const onSSTimer = STATION1.datetime.ll9.step1.onSSTimer;
    ...
    // Off
    const offHH = STATION1.datetime.ll9.step1.offHH;
    const offHHTimer = STATION1.datetime.ll9.step1.offHHTimer;
    ...
    const offMM = STATION1.datetime.ll9.step1.offMM;
    const offMMTimer = STATION1.datetime.ll9.step1.offMMTimer;
    ...
    const offSS = STATION1.datetime.ll9.step1.offSS;
    const offSSTimer = STATION1.datetime.ll9.step1.offSSTimer;
